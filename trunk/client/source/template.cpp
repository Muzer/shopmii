...
//---------------------------------------------------------------------------------
	...
	//
	// Insert list of games here - for simplicity's sake, this will ideally be in the same function as much as possible. Although passing the db as an argument could be possible.
